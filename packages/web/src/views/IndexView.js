            ...
            <div className="af-class-body">
              ...
              <div className="af-class-section af-class-is--80padding af-class-no-bottom af-class-wf-section">
                <div className="af-class-_1077_container">
                  <div className="af-class-heading--137 af-class-_24margin-bottom">OFFSCRIPTNFT AND TICKETS</div>
                  <div className="af-class-grid-2 af-class-_3 af-class-_60margin-top">
                    <div id="w-node-_3dc5a527-52b0-4f8c-ecfd-3fbeff791505-6fc6f102" className="af-class-left">
                      <div className="af-class-faq--question-title">Mint the NFT:<br /></div>
                      <div className="af-class-text--20">· Show your support for, and interest in Offscript<br />· Buy a beautiful art work by @tasty_plots<br />· Get a discount of 10%, 25%, 40% or 100%<br />‍<br />
                    ...
                    <div id="w-node-_3dc5a527-52b0-4f8c-ecfd-3fbeff791525-6fc6f102" className="af-class-right">
                      <div className="af-class-overflow_hidden">
                        <div className="af-class-faq--question-title">Buy the ticket:<br /></div>
                        <div className="af-class-text--20">· Apply OffscriptNFT discount<br />· Buy with ETH, DAI, USDC, USDT<br />· Buy with fiat <a href="https://ti.to/offscript" target="_blank">here</a><br />‍<br />
                          <a href="https://mirror.xyz/0x8C4F71B3cF6a76dE2CC239a6fA84E1a80e589598/3BufLjx7teLfeIR4U6dPcD2NIMFZp7siASk1wDPXXbk" target="_blank">More info here</a><br />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="af-class-text--20 af-class-_100margin-top af-class-align-center">Connect your wallet to Mint an OffscriptNFT or Buy a Ticket </div>
                </div>
              </div>
              ...
              <SectionMintView.Controller-success />
              ...
              <div className="af-class-section af-class-is--footer af-class-wf-section">
                <div className="af-class-_1360_container af-class-is--20padding-tablet">
                  ...
                  <div className="af-class-overflow_hidden">
                    <a href="https://www.web3creatives.com/" className="af-class-brand_link w-inline-block"><img src="images/OffScript-Logo-2.png" loading="lazy" sizes="100vw" srcSet="images/OffScript-Logo-2-p-500.png 500w, images/OffScript-Logo-2-p-800.png 800w, images/OffScript-Logo-2-p-1080.png 1080w, images/OffScript-Logo-2.png 2708w" alt="Offscript logo" className="af-class-footer_logo af-class-animation-fadein" /></a>
                  </div>
                </div>
                ...
                <div className="af-class-_1360_container af-class-is--footer">
                  <div className="w-layout-grid af-class-grid--footer af-class-is--crendentials">
                    ...
                    <div id="w-node-_6fc7bdae-7f9d-4b12-9c8e-da48b4f287ac-6fc6f102" className="af-class-overflow_hidden">
                      <div className="af-class-text--20 af-class-is--50opacity af-class-animation-fadein">
                        <a href="https://web3creatives.notion.site/Offscript-Terms-and-conditions-569cc25f4714418b9055bdac45ffbc94" rel="noopener" aria-label="Privacy Policy" target="_blank" className="af-class-credentialslink">Terms &amp; Conditions</a>
                      </div>
                    </div>
