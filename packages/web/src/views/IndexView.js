                ...
                <div className="af-class-_1077_container">
                  <div className="af-class-overflow_hidden">
                    ...
                    <div className="af-class-text--20">- Show your support for, and interest in Offscript<br />- Buy a beautiful art work by @tasty_plots<br />- Get a discount of 10%, 25%, 40% or 100%<br />‍<br />
                      <a href="https://mirror.xyz/0x8C4F71B3cF6a76dE2CC239a6fA84E1a80e589598/Tya8b-rNzMWGQfOZZzpsV8BKnb8ZKbXIyZB9F8eVXgc" target="_blank">More info here</a><br /><br />Connect your wallet to Buy and Mint an NFT
                    </div>
                  </div>
                </div>
              </div>
