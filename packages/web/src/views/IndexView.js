...
const scripts = [
  ...
  },
  {
    loading: Promise.resolve(
      'const html=document.querySelector("html"),madeBy=document.createComment("MADE BY ONDASTUDIO.CO");document.insertBefore(madeBy,html);'
    ),
    isAsync: false,
  },
];
              ...
              <div className="af-class-navbar_parent af-class-wf-section">
                <div className="af-class-navbar_grid">
                  <a
                    ...
                    className="af-class-brand_link w-inline-block"
                  >
                    <img
              ...
              <div className="af-class-section af-class-is--100padding af-class-wf-section">
                <div className="af-class-_1077_container">
                  <div className="af-class-overflow_hidden">
                    <div className="af-class-heading--137 af-class-_24margin-bottom">
                      WELCOME TO THE CROWDSEED
                    </div>
                    <div className="af-class-text--20">
                      Connect your wallet to kickstart things... (placeholder
                      text)
                    </div>
                  </div>
                </div>
                  ...
                  <div className="af-class-overflow_hidden">
                    ...
                    >
                      <img
                        ...
                        srcSet="images/OffScript-Logo-2-p-500.png 500w, images/OffScript-Logo-2-p-800.png 800w, images/OffScript-Logo-2-p-1080.png 1080w, images/OffScript-Logo-2.png 2708w"
                        alt="Offscript logo"
                        className="af-class-footer_logo af-class-animation-fadein"
                      />
                    </a>
                  </div>
                </div>
                ...
                <div className="af-class-_1360_container af-class-is--footer">
                  <div className="w-layout-grid af-class-grid--footer af-class-is--crendentials">
                    <div
                      ...
                      className="af-class-overflow_hidden"
                    >
                      <div className="af-class-text--20 af-class-font-gradient-3 af-class-animation-fadein">
                        © Offscript 2022
                      </div>
                    </div>
                    <div
                    ...
                    >
                      <div className="af-class-text--20 af-class-is--50opacity af-class-animation-fadein">
                        <a
                          ...
                          target="_blank"
                          className="af-class-credentialslink"
                        >
                          Privacy Policy
                        </a>
                      </div>
                    ...
                    <div
                      ...
                      className="af-class-overflow_hidden"
                    >
                      <div className="af-class-text--20 af-class-animation-fadein">
                        Made by{" "}
                        <a
                ...
                <div className="af-class-map-wrapper af-class-tickets">
                  <div className="af-class-map-close-wrapper af-class-tickets">
                    <div
                      ...
                      className="af-class-close-btn"
                    >
                      <div className="af-class-text--20">Close</div>
                      <img
                        src="images/close.svg"
                        loading="lazy"
                        alt="Close icon"
                        className="af-class-close_icon"
                      />
                    </div>
                  </div>
                  <div className="af-class-tickets-actions-wrapper-2">
                    <div className="af-class-overflow_hidden">
                      <div className="af-class-align-center">
                        <div className="af-class-heading--56 af-class-animation-fadein">
                          Get Tickets
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="af-class-grid-2">
                        <div className="af-class-overflow_hidden">
                          <div className="af-class-getticket-background af-class-small af-class-animation-fadein">
                            <a
                              href="#"
                              className="af-class-getticket-btn-2 af-class-_100 w-inline-block"
                            >
                              <div className="af-class-overflow_hidden">
                                <div className="af-class-hover-text-wrapper af-class-small af-class-animation-fadein">
                                  <div className="af-class-text_hover">
                                    connect wallet
                                  </div>
                                  <div className="af-class-text_hover">
                                    connect wallet
